...
function getCaretOffset(element) {
    ...
    if (typeof doc == "undefined") {
      lt_debug('TRACE|NOELEMENT='+element,6);
      return -1;
    }
...
function lt_nextIssue (firstOpen) {
    ...
    var suggestionsList = $( sgfunc['dialog_suggestions'].call() );
...
console.log( "checked",$('#lt-filter-check-'+sgstore['lt'][uuid][hid]['rule']['issueType']+'[checked="false"]') );
    
if ( (firstOpen||0) == 0 ) {

if ( $('#lt-filter-check-'+sgstore['lt'][uuid][hid]['rule']['issueType']+'[checked="false"]').length == 1 ) {
...
sgfunc['dialog_setmessage'].call( '[' + sgstore['lt'][uuid][hid]['rule']['issueType'].charAt(0).toUpperCase() + sgstore['lt'][uuid][hid]['rule']['issueType'].slice(1) + '] ' + sgstore['lt'][uuid][hid]['message']  )


  $.each(sgstore['lt'][uuid][hid]['replacements'],function(key,val) {

suggestionsList.data('ident-UUID', uuid);
suggestionsList.data('ident-HID', hid);

if ( (key == 0) ) {
sgfunc['dialog_setchangeto'].call(val['value']);
}
